...
class _TopupScreenState extends State<TopupScreen> {
  ...
  Future topupMoney() async {
    ...
    if (formState.validate()) {
      ...
      AccountService.topupMoney(context, _amount).then((bool success) {
        if (success) {
          ...
          NotificationItemCM notiCM = NotificationItemCM(
            title: 'eTutor Wallet',
            body: 'Top Up successfully with amount of ${_amountStr}VND',
